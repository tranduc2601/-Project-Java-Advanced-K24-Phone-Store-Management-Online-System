...
public class CustomerMenu {
    ...
    private void browseProducts() {
        TablePrinter.printHeader("SAN PHAM CON HANG");
    ...
    private void addToCart(Scanner scanner) {
        ...
        if (!found) {
            cart.add(new CartItem(productId, product.getProductName(), quantity, product.getPrice()));
        }
    ...
    private void viewCart() {
        ...
        System.out.printf(format, "STT", "Ten san pham", "SL", "Don gia", "Thanh tien");
        System.out.println(line);
        ...
        for (CartItem item : cart) {
            ...
            System.out.printf(format, stt++, name, item.getQuantity(),
                    TablePrinter.formatCurrency(item.getUnitPrice()),
                    TablePrinter.formatCurrency(subTotal));
        }
        System.out.println(line);
        System.out.println("TONG CONG: " + TablePrinter.formatCurrency(total));
    }
    ...
    private void checkout(Scanner scanner, User customer) {
        ...
        if (orderService.checkout(customer.getUserId(), cart, address)) {
            cart.clear();
        }
    }
    ...
    private void viewOrderHistory(Scanner scanner, User customer) {
        ...
        TablePrinter.printHeader("LICH SU DON HANG CUA BAN");
